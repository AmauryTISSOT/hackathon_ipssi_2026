from backend.sirene.src.request_and_bronze import fetch_sirene_data, save_to_bronze
from backend.sirene.src.silver import extract_essential_fields, save_to_silver
def main():
